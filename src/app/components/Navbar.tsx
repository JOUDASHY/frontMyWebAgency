          ...
          >
            <div className="relative">
              <img 
                src="/logo.png"
                alt="Profile Icon"
                className="w-8 h-8 md:w-12 md:h-12 rounded-full border-2 bg-[var(--jaune)] object-cover transition-all group-hover:border-indigo-300"
              />
            ...
            <span className="text-xl md:text-2xl font-bold bg-gradient-to-r text-[var(--jaune)]">
              THE BEAST
