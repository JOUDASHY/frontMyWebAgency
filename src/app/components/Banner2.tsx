...
const Banner2 = () => {
  ...
  return (
    <section className="relative h-[70vh] min-h-[400px] md:h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-5 md:px-6 lg:px-8 text-center">
        ...
        ">
          ...
          <span className="
            text-lg sm:text-xl md:text-2xl lg:text-[2.5rem]
            text-purple-200 block sm:inline
        ...
        <p className="
          ...
          text-purple-50 mb-4 sm:mb-6 md:mb-8
